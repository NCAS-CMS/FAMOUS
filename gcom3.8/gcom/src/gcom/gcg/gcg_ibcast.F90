...
SUBROUTINE GCG_IBCAST (MSG, LEN, SEND, GID, ISTAT, SARR)
!     ******************************************************************
!     * Purpose:
!     *
!     *  Broadcast an integer array to every processor of a group.
!     *
!     * Input:
!     *  MSG     - message tag
...
IF (ISTAT  ==  -1) RETURN
RANK = ISTAT
CALL MPL_BCAST(SARR, GC__ISIZE*LEN, MPL_BYTE, RANK,               &
               IGID, ISTAT)
#endif
