...
CLL version  date
CLL  3.2     25/03/93  Removed one-sided differencing for first and last
CLL                    points if not global.
CLL                    Author: C.A.Wilson     Reviewer: A.Dickinson
!   3.5    28/03/95 MPP code: Take account of halos    P.Burton
!   4.1    02/04/96 Modifications to MPP code    P.Burton
...
C*L  Arguments:---------------------------------------------------
      SUBROUTINE UV_TO_P
     1  (U_DATA,P_DATA,U_FIELD,P_FIELD,ROW_LENGTH,ROWS)
