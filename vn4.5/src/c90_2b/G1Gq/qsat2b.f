...
CLL VERSION  DATE
CLL    ###### NOTE: VERSION IS T3E OPTIMISED, IMPROVED FORMULATION (2B)
CLL
!LL   4.4   11/08/97  New version optimised for T3E.
!LL                   Not bit-reproducible with QSAT2A.
CLL  4.4   11/8/97   Replace IF statements by MAX or MIN to improve
CLL                  speed of code on T3E.
CLL                  D. Salmond/A. Dickinson
