...
C ******************************COPYRIGHT******************************
C
!+ Interfaces GWAV_CTL to version 3A of gravity wave drag scheme.
!
...
! wave drag scheme, and according to *IF DEF (A06_3A in this case)
! calls corresponding actual G_WAVE routine with only those
...
C-------------------------------------------------------------------
CL    1.   Call Gravity Wave Drag Scheme version 3A.
C-------------------------------------------------------------------
