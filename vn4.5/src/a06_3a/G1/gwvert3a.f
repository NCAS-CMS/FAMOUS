...
!  4.1   27/03/96   Mod to ensure H_CRIT is set correctly (S.Webster)
...
!      S_STRESS/3. If a critical level has been found GW_SATN skipped
!---------------------------------------------------------------------
      CALL GW_SATN
...
!------------------------------------------------------------------
!  7.0 SET ACCELERATION SAME IN ALL LAYERS 2 UP TO START_L
!------------------------------------------------------------------
      DO KK=2,START_L-1
        DO I=1,POINTS
