...
CLL                                                     R.N.B.Smith
CLL
CLL  4.4  08/09/97 Logical switch L_BL_LSPICE specifies mixed phase
CLL                precipitation scheme.       D.Wilson
CLL
...
C
     ...
     &,L_CO2_INTERACTIVE   ! dummy CO2 variable - not used with A03_5A.
...
C                                !    land point.
     ...
     &,CO2_DIM       ! dummy CO2 variable - field not used with A03_5A.
C
      REAL
...
C
     ...
     &,CO2_3D        ! dummy CO2 variable - field not used with A03_5A.
...
C IN soil/vegetation/land surface data :
     ...
     +,STHF,STHU,VFRAC,Z0V,SIL_OROG_LAND
...
C INOUT data :
     +,Q,GS,T,T_DEEP_SOIL,TI,TSTAR,U,V,Z0MSEA

C OUT Diagnostic not requiring STASH flags :
     +,CD,CH,E_SEA,EPOT,ETRAN,FQW,FSMC,FTL,H_SEA,RHOKH,RHOKM,RIB
     +,SEA_ICE_HTF,SURF_HT_FLUX,TAUX,TAUY,VSHR
