...
CLL VERSION  DATE
CLL  4.0  17/01/95  Original code.  T.Davies.
...
! End of comdeck TYPFLDPT
     ...
     *,DIFFUSION_EW(P_FIELD)   !OUT EFFECTIVE EW DIFFUSION COEFFICIENT
     *,DIFFUSION_NS(P_FIELD)   !OUT EFFECTIVE NS DIFFUSION COEFFICIENT
...
! Loop over field missing Northern row
      ...
      DIFFUSION_NS(I)=0.5*(DIFFUSION_COEFFICIENT2(I)*COS_P_LATITUDE(I)
...
C  RECALCULATE END POINTS.
      ...
      DIFFUSION_NS(LAST_U_FLD_PT)=DIFFUSION_NS(LAST_U_FLD_PT-1)
...
! North Pole
        DO I=TOP_ROW_START,TOP_ROW_START+ROW_LENGTH-1
          DIFFUSION_NS(I)=DIFFUSION_COEFFICIENT2(I)*COS_P_LATITUDE(I)*
     &                    LATITUDE_STEP_INVERSE*LATITUDE_STEP_INVERSE
        ENDDO
      ENDIF
