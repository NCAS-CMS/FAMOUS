...
CLL VERSION  DATE
!LL  4.4     07/10/97 New version optimised for T3E
!LL                   Not bit-reproducible with THETLQ1A
CLL
...
C DEFINE LOCAL VARIABLES
      ...
      REAL
     *  P_EXNER_FULL_R !HOLDS RECIP EXNER PRESSURE AT FULL LEVEL.
