...
CMIC$ PARALLEL SHARED(ROW_LENGTH,P_FIELD,VORTICITY2,SEC_P_LATITUDE,
CMIC$1   RS_ON_THETA,DRSCOSPHIU_DLATITUDE,U_FIELD,
CMIC$2   LATITUDE_STEP_INVERSE,RS_UV_ON_THETA,COS_U_LATITUDE,
CMIC$3   U_ON_THETA,LONGITUDE_STEP_INVERSE,V_ON_THETA,DRSV_DLONGITUDE)
CMIC$4   PRIVATE(J,I)
...
!OCL NOVREC
 ...
 120    continue
        ...
        drsv_dlongitude(FIRST_FLD_PT) = 0.
...
!OCL NOVREC
     ...
     &                           drscosphiu_dlatitude(j)-
     &                           drscosphiu_dlatitude(j-1))
 130    continue

C Zero vorticity2 on boundaries.
