...
CMIC$ PARALLEL SHARED(ROW_LENGTH,P_FIELD,VORTICITY5,RS_ON_PRESS,
CMIC$1   SEC_P_LATITUDE,DCOSPHIU_DLATITUDE,U_FIELD,COS_U_LATITUDE,
CMIC$2   LATITUDE_STEP_INVERSE,U_ON_PRESS,LONGITUDE_STEP_INVERSE,
CMIC$3   V_ON_PRESS,DV_DLONGITUDE) PRIVATE(J,I)
...
!OCL NOVREC
     ...
     &                      dcosphiu_dlatitude(j)-
     &                      dcosphiu_dlatitude(j-1))
 130    continue

C Zero vorticity5 on boundaries.
