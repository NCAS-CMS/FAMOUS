...
! Subroutine Arguments:
      ...
      INTEGER
     * NFTIN         !IN Unit number for I/O
     *,NENV          !IN Length of ENV
     *,READ_WRITE    !IN =0 read only, <> 0 read and write
     *,ENV_VAR       !IN =0 file name stored in environment var
...
! ------------------------------------------------------------------
      ...
      ERR=0
      IF (mype .EQ. 0) THEN    ! only PE 0 does any I/O
