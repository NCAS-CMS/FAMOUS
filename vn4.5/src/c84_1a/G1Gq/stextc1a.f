...
CLL  Routine: STEXTC ---------------------------------------------------
CLL
CLL  Purpose: Extracts a weighted subfield within a region specified
CLL           by a lower left hand and upper right hand corner.
CLL           Single level at a time. (STASH service routine).
CLL
...
CLL
CLL  Logical components covered: D711
CLL
CLL  Project task: D7
CLL
...
C
      SUBROUTINE STEXTC(fieldin,vx,vy,st_grid,lwrap,lmasswt,
