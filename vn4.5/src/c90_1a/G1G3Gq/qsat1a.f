...
CLL
CLL   PURPOSE:
CLL          RETURNS A SATURATION SPECIFIC HUMIDITY GIVEN A TEMPERATURE 
...
CLL VERSION  DATE
CLL    ###### NOTE: VERSION IS ORGINAL VERSION (1A)
CLL
CLL  PROGRAMMING STANDARDS :
CLL
CLL  LOGICAL COMPONENTS COVERED: P27
CLL
CLL  DOCUMENTATION : UNIFIED MODEL DOCUMENTATION PAPER 29
CLL
CLLEND-----------------------------------------------------------------
C
C*L  ARGUMENTS---------------------------------------------------------
