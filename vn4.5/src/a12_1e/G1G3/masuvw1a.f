...
C ******************************COPYRIGHT******************************
C
CLL   SUBROUTINE MASS_UWT_UV  -----------------------------------------
CLL
CLL   PURPOSE:   CALCULATES RS AND REMOVES MASS WEIGHTING FROM U AND V
CLL
CLL   NOT SUITABLE FOR SINGLE COLUMN USE.
CLL
CLL  MODEL            MODIFICATION HISTORY:
CLL VERSION  DATE
CLL  4.0  02/02/95  Original code: T.Davies
!     4.1    02/04/96 Added MPP code  P.Burton
CLL
...
C*L   ARGUMENTS:---------------------------------------------------
      SUBROUTINE MASS_UWT_UV
     1                   (RS_SQUARED_DELTAP,RS,U,V,PSTAR,AK,
