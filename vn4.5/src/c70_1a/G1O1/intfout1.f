...
CLL  Model            Modification history:
CLL version  Date
CLL  4.5  03/09/98  New COMDECK. Author M.J.Bell
C
C
      INTEGER  MAX_N_INTF_O     ! Max no. of ocean interface areas
      PARAMETER (MAX_N_INTF_O = 4)
      INTEGER  MAX_INTF_LEVELS_O  ! Max no. of ocean interface levels
      PARAMETER (MAX_INTF_LEVELS_O = 40 )
