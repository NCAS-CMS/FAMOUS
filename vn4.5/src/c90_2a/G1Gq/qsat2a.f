...
C ******************************COPYRIGHT******************************
C
CLL  SUBROUTINES QSAT_WAT AND QSAT ----------------------------------
CLL
CLL   PURPOSE:
CLL             RETURNS A SATURATION MIXING RATIO GIVEN A TEMPERATURE
CLL AND PRESSURE USING SATURATION VAPOUR PRESSURES CALCULATED USING THE
CLL GOFF-GRATCH FORMULAE, ADOPTED BY THE WMO AS TAKEN FROM
CLL LANDOLT-BORNSTEIN, 1987 NUMERICAL DATA AND FUNCTIONAL RELATIONSHIPS
CLL IN SCIENCE AND TECHNOLOGY. GROUP V/VOL 4B METEOROLOGY.  PHYSICAL AND
CLL CHEMICAL PROPERTIES OF AIR, P35
CLL
CLL VALUES IN THE LOOKUP TABLE ARE OVER WATER ABOVE AND BELOW 0 DEG C.
CLL
CLL NOTE : FOR VAPOUR PRESSURE OVER WATER THIS FORMULA IS VALID FOR
CLL TEMPERATURES BETWEEN 373K AND 223K.  THE VALUES FOR SATURATED VAPOUR
CLL OVER WATER IN THE LOOKUP TABLE BELOW ARE OUT OF THE LOWER END OF
CLL THIS RANGE.  HOWEVER IT IS STANDARD WMO PRACTICE TO USE THE FORMULA
CLL BELOW ITS ACCEPTED RANGE FOR USE WITH THE CALCULATION OF DEW POINTS
CLL IN THE UPPER ATMOSPHERE
CLL
...
CLL VERSION  DATE
CLL    ###### NOTE: VERSION IS IMPROVED FORMULATION (2A)
CLL
CLL  4.0    3/7/95   NEW DECK AT VERSION 4.0.
CLL                  CORRECTIONS INTRODUCED TO GIVE MORE ACCURATE
CLL                  CALCULATION OF SATURATED SPECIFIC HUMIDITY.
CLL                  DAVID ROBERTS/PETER INNESS.
CLL
...
C*L  ARGUMENTS---------------------------------------------------------
C
      SUBROUTINE QSAT_WAT (QS,T,P,NPNTS)
C
      IMPLICIT NONE
C
C----------------------------------------------------------------------
...
C
C VALUES ABOVE AND BELOW 0 DEG C ARE OVER WATER
C
C VALUES BELOW -50 DEC C ARE OUTSIDE FORMAL RANGE OF
C WMO ADOPTED FORMULA (SEE ABOVE).  HOWEVER STANDARD
C PRACTICE TO USE THESE VALUES
C---------------------------------------------------------------------
C
...
C
C     USE THE LOOKUP TABLE TO FIND SATURATED VAPOUR PRESSURE,
