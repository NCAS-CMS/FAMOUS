...
!        if a rotated global grid is used.
      ...
      ELSE ! global correction scheme
        ...
        IF (at_top_of_LPG .AND. at_right_of_LPG) THEN
          COS_P_LAT_NP=COS_P_LATITUDE(TOP_ROW_START+LAST_ROW_PT-1)
          SEC_P_LAT_NP=SEC_P_LATITUDE(TOP_ROW_START+LAST_ROW_PT-1)
          COS_P_LATITUDE(TOP_ROW_START+LAST_ROW_PT-1)=
     &      GLOBAL_ROW_LENGTH*COS_P_LAT_NP
     ...
     &      GLOBAL_ROW_LENGTH*COS_P_LAT_SP
