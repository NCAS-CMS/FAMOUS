...
!
!   A04_2B : Change to LSP_EVAP, fpl = 0.
!   A04_2C : Change to LSP_EVAP, fpl = 1.
!
!   Called by : LSPP_CTL1
!
...
!   4.5  03/09/98  Added dummy 3D rain and snow variables. D.Wilson
!   4.5  28/09/98   Add NH3 and soot variables to argument list
!                   (dummies as S Cycle and soot not in A04_2B) MJW
...
!                                (Upper minus lower).
      REAL LS_GRID_QC(PFIELD,Q_LEVELS) ! DUMMY VARIABLE.
      REAL LS_BS(PFIELD,Q_LEVELS)      ! DUMMY VARIABLE.
!
