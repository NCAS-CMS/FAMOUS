...
! Loop over field, missing top and bottom rows and halos, and first
! and last points.
      DO 224 I=START_POINT_NO_HALO+1,END_U_POINT_NO_HALO-1
...
CL---------------------------------------------------------------------
      ...
      DO 400 I=START_POINT_NO_HALO+1,END_U_POINT_NO_HALO-1
...
! Set first point of each row to zero
        DO I=START_POINT_NO_HALO+FIRST_ROW_PT-1,END_U_POINT_NO_HALO,
     &       ROW_LENGTH
          WK(I)=0.0
          OMEGA(I)=0.0
          WK(I-1)=0.0  
          OMEGA(I-1)=0.0
        ENDDO
! Set last two points of each row to zero
