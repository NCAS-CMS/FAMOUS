...
CLL VERSION  DATE
!LL   4.2   28/10/96  New deck for HADCM2-specific section A10_1B,
!LL                   as VERTVE1A but with inconsistent 'old' type
!LL                   of polar weights.  T.Johns
!LL   4.3   14/04/97  Updated in line with MPP optimisations.  T Johns
CLL
