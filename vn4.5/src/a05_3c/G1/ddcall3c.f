...
!LL                   Not bit-reproducible with DDCALL3A.
!LL                                                  Alan Dickinson
!LL  4.4   17/10/97  Loop splitting by hand for T3E optimisation
!LL                                                   D.Salmond
!LL  4.5   19/05/98  Pass L_PHASE_LIM down to DOWND to determine
...
C
     ...
     *                    EFLUX_V_DD,L_TRACER,NTRA,
     ...
     &                    L_PHASE_LIM,DD_FLUX,FLG_DWN_FLX,
     &                    ENTRAIN_DWN,FLG_ENTR_DWN,DETRAIN_DWN,
     &                    FLG_DETR_DWN
     &                    )
C
      IMPLICIT NONE
