...
!                           used.
!     4.3        03/02/97   Pass logical switches L_SDXS and L_XSCOMP 
!                           down to CONVECT.
...
!
      LOGICAL L_CLOUD_DEEP        ! IN IF TRUE LIMITS PHASE CHANGE OF
!                                 !    PRECIP IF LH WILL TAKE TEMP TO
!                                 !    OTHER SIDE OF TM.
!
      LOGICAL L_PHASE_LIM         ! IN SWITCH TO DETERMINE IF PHASE
!                                 !    CHANGE OF PRECIP IS LIMITED TO
!                                 !    ENSURE LH DOES NOT TAKE TEMP
!                                 !    TO OTHER SIDE OF TM
!                                                                       
C
