...
!LL                                                   D.Salmond
!LL  4.4  26/09/97  Logical L_CCW passed in to determine if precip is
!LL                 included in water path. MPARWTR passed down as an
!LL                 argument at versions 3A and 3B.       J.M.Gregory
...
!                            !    used in radiation, if L_CCW=TRUE.
!
