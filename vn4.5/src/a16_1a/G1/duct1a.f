...
! land points
          ...
          DO WHILE (((offset .LE. max_off) .AND. (.NOT. end)) .AND.
     &              .NOT. ((atright) .AND.
     &              (extended_J+offset .LE.
     &               extended_ROW_LENGTH-max_off)))
...
! land points
          ...
          IF (LAND(point_set) .AND.
     &        .NOT.(atleft .AND. extended_J .EQ. max_off+1)) THEN
            ...
            DO WHILE (((offset .LE. max_off) .AND. (.NOT. end)) .AND.
     &                 .NOT.(atleft .AND.
     &                       (extended_J-offset .GE. max_off+1)))
...
C-----------------------------------------------------------------------
        ABAR(POINT)=(IW2*A(POINT-ROW_LENGTH)+IW1*A(POINT-ROW_LENGTH+1)
     1   +IW3*A(POINT)+IW2*A(POINT+1)
     2   +IW2*A(POINT+ROW_LENGTH)+IW1*A(POINT+ROW_LENGTH+1))/IW6
C-----------------------------------------------------------------------
C
C-----------------------------------------------------------------------
  600 CONTINUE
...
C-----------------------------------------------------------------------
        ABAR(POINT)=(IW1*A(POINT-ROW_LENGTH-1)+IW2*A(POINT-ROW_LENGTH)
     1   +IW2*A(POINT-1)+IW3*A(POINT)
     2   +IW1*A(POINT+ROW_LENGTH-1)+IW2*A(POINT+ROW_LENGTH))/IW6
C-----------------------------------------------------------------------
C
C-----------------------------------------------------------------------
  700 CONTINUE
