...
! End of DECOMPDB comdeck
      ...
      real   Zwork_aice_previous(p_field) ! Temp array to store the
                                !           ice fraction.
...
C
      ...
      g_row_length = decomp_db_glsize(1,decomp_standard_atmos)
      g_p_rows     = decomp_db_glsize(2,decomp_standard_atmos)
      g_u_rows     = g_p_rows - 1
      write(nulou,*)
     &  'g_row_length, g_p_rows, g_u_rows, g_p_field ',
     &  g_row_length, g_p_rows, g_u_rows, g_p_field
