...
CLL                                                       S.J.Swarbrick
CLL   4.0      1/02/95  Polar weighting defined by polar values of
CLL                     SEC_P_LATITUDE made consistent with other parts
CLL                     of dynamics.  C.D.Hall
!     3.5    28/03/95 MPP code addition.  P.Burton
...
C ---------------------------------------------------------------------
      ...
      DO 230 K= 1,P_LEVELS
CFPP$ SELECT(CONCUR)
        DO 232 I=START_POINT,END_POINT
...
! point.
!          DO I=P_BOT_ROW_START+FIRST_ROW_PT,
