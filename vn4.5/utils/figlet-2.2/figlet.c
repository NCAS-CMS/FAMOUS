...
int infonum;
{
  switch (infonum) {
    case 0: /* Copyright message */
      printf("FIGlet Copyright 1991-1996 Glenn Chappell, Ian Chai, ");
      printf("John Cowan\n");
      printf("Internet: <ggc@uiuc.edu> and <chai@uiuc.edu> ");
      printf("and <cowan@ccil.org>\n");
      ...
      printf(" FTP from\n");
      printf("ftp.nicoh.com in directory \"pub/figlet\", or from the ");
